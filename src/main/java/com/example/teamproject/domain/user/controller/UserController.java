...
//    }
     ...
     */
    @GetMapping("/me")
    public ResponseEntity<UserDto> getMyPage(@RequestHeader("userId") Long userId) {
     ...
     */
    @PatchMapping("/update")
    public ResponseEntity<UserDto> updateUser(@RequestHeader("userId") Long userId, @RequestBody UpdateUserDto dto) {
    ...
    public ResponseEntity<ByteArrayResource> downloadProfileImage(@RequestHeader("userId") Long userId) {
    ...
    public ResponseEntity<String> requestPromotion(@RequestHeader("userId") Long userId) {
